...
exports.generateQrCode = async (req, res) => {
  ...
  try {
    ...
    console.log("NETS Request Body:", JSON.stringify(requestBody));
    ...
    console.log("NETS Response Status:", response.status);
    console.log("NETS Response Data:", JSON.stringify(response.data, null, 2));
    ...
    if (error.response?.data) {
      console.error("NETS API Error Response:", JSON.stringify(error.response.data, null, 2));
    }
